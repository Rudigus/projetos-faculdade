...
public class Main {
    ...
    private static JComboBox inspectorComboBox;
    private static JLabel stateValueLabel;
    ...
    public static void main(String[] args) {
        ...
        // Misc
        inspectorComboBox = new JComboBox() {
            /**
             * @inherited <p>
             */
            @Override
    ...
    public static void changeWagonState(Wagon.State wagonState) {
        wagon.state = wagonState;
        if (inspectorComboBox.getSelectedItem() instanceof Wagon) {
            stateValueLabel.setText(wagonState.toString());
        }
    }

    public static void changePassengerState(int passengerID, Passenger.State passengerState) {
        passengers.get(passengerID - 1).state = passengerState;
        Object selectedItem = inspectorComboBox.getSelectedItem();
        if (selectedItem instanceof Passenger && ((Passenger) selectedItem).id == passengerID) {
            stateValueLabel.setText(passengerState.toString());
        }
    }
}
